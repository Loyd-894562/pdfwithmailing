<template>
    <div class="bg-red-200 border border-red-300 shadow-lg rounded text-red-800 p-4 mx-12 mt-4 flex items-center"
        v-if="messages.err">
        <svg fill="#ff0000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" width="40px" height="40px" viewBox="0 0 478.125 478.125"
            xml:space="preserve">
            <g>
                <g>
                    <g>
